...
The reasons mentioned above explain why many universities are implementing 
RISC architecture in their undergraduate and master's degree programs related to 
embedded systems. For example, the STM32F4-DISCOVERY development board 
is used as part of the course materials for the Embedded Systems I and II courses 
in the Master's in Electronic Systems at the UPM.
