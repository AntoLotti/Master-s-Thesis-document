...
This subsystem implements a type system using pure C which, despite C's 
lack of native object-oriented programming (OOP) features, allows dynamic type 
registration, inheritance, and runtime polymorphism, providing \cite{Qemu_QOM}:
