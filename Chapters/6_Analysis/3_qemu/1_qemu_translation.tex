...
boundaries\cite{QemuTCGOpsDevel}\cite{QemuTCGDirectBlockChaining}. The translation performed by the TCG consists of two phases: 
converting the host code into a sequence of micro-operations and turning these micro-operations 
into executable code\cite{QemuTCGTechReport}. The figure \ref{fig:tcg} illustrates the general 
architecture and workflow of the TCG.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Resources/Imagenes/TCG.png}
