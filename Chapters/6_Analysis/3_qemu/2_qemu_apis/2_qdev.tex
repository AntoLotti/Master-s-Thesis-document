...
Similar to the QOM API, there are several key elements of the QDev API that 
will be used and mentioned throughout the thesis. These elements are described in 
Annex~\ref{ann:qemu_c_structures} and will be more important in section XXXX.
