...
I$^2$C interface, was selected in this thesis for integration into QEMU and to test the 
I$^2$C interface of the emulated STM32F405 microcontroller.

\subsubsection{Characteristics}

The LIS3DH~\cite{LIS3DHDatasheet2016} is an ultra-low-power, high-performance, three-axis 
linear accelerometer belonging to the "nano" family, with a standard I$^2$C/SPI digital 
