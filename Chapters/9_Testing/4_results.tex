...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|X|}
        ...
        \hline
        Configuration Correctness & TC2/TC3 & \textcolor{green}{PASSED} & 
        Write in the control registers change the internal logic \\
        \hline
        Data Acquisition & TC4 & \textcolor{green}{PASSED} & 
        QOM → registers → perfect mg scaling \\
        \hline
        Interrupt Behavior & TC5 & \textcolor{green}{PASSED} & 
        DRDY → EXTI → clear non-latched working \\
        \hline
        5. HAL Compatibility & All & \textcolor{green}{PASSED} (Native) & 
