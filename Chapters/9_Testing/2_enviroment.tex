...
\begin{enumerate}
  ...
  Then assign the \texttt{I2C1\_SCL} and \texttt{I2C1\_SDA} lines to pins PB6 and PB7, respectively.
  
  \item Configure a UART peripheral to enable debugging.
  
  \item Reconfigure pin PA1, which is wired to the LIS3DH INT1 pin, to 
  \textbf{GPIO} \textbf{\_EXTI1} mode. In the configuration for this pin, select 
