\section{I2C Controller Design}
\label{chap:design_i2c_controler}


As explained during the analysis, the I2C controller model of the STM32F405 
...
hardware to generate the I2C protocol events. This condition must be met for the 
emulated hardware to be able to execute the same I2C events in QEMU.

The analysis shows that the generation of I2C events in the controller model 
depends not only on the current state of the registers but also on the previous I2C 
...
After an extensive reading of the I2C protocol in the STM32F405 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Resources/Imagenes/fsm.png}
